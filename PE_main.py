...
if __name__ == '__main__':
    ...
    clf = joblib.load('E:/project/Malware-Detection-using-Machine-learning/Classifier/classifier.pkl')
    features = pickle.loads(open(os.path.join('E:/project/Malware-Detection-using-Machine-learning/Classifier/features.pkl'),'rb').read())
